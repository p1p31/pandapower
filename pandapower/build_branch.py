...
from pandapower.pypower.idx_brch import F_BUS, T_BUS, BR_R, BR_X, BR_B, TAP, SHIFT, BR_STATUS, RATE_A, RATE_B, RATE_C, \
...
def _calc_line_parameter(net, ppc, elm="line", ppc_elm="branch"):
    ...
    **RETURN**:
    ...
    branch[f:t, RATE_B] = branch[f:t, RATE_A]
    branch[f:t, RATE_C] = branch[f:t, RATE_A]
